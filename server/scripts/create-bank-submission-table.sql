-- BankSubmission Table Migration
-- Creates the BankSubmission table used by bank-workflow.service.ts
...
CREATE INDEX IF NOT EXISTS "idx_banksubmission_lan" ON "BankSubmission"("lanNumber");
CREATE UNIQUE INDEX IF NOT EXISTS "idx_banksubmission_app_bank" ON "BankSubmission"("applicationId", "bankId");

GRANT SELECT, INSERT, UPDATE, DELETE ON "BankSubmission" TO anon;
GRANT SELECT, INSERT, UPDATE, DELETE ON "BankSubmission" TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON "BankSubmission" TO service_role;
